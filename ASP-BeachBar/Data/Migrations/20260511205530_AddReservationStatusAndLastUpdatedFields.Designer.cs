...
namespace ASP_BeachBar.Data.Migrations
{
    ...
    [Migration("20260511205530_AddReservationStatusAndLastUpdatedFields")]
    partial class AddReservationStatusAndLastUpdatedFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP_BeachBar.Data.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASP_BeachBar.Data.NavigationMenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASP_BeachBar.Data.Reservation", b =>
                {
                    ...
                    b.HasOne("ASP_BeachBar.Data.Event", "Events")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ASP_BeachBar.Data.Client", null)
                        .WithMany()
